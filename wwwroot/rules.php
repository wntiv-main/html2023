...
<body>
	<article class="content parallax-container">
		...
		<section class="parallax-object parallax-mid uline">
			<div class="content-box">
				<h2 class="welcome gradient-text accent3 moveable-background">Rules</h2>
			</div>
		</section>
		<section class="parallax-object parallax-mid-front">
			<div class="content-box">
				Attending the Senior Formal is a privilege, not a right. As in previous years there are limited
				tickets and a strict criteria applies to all students wishing to attend this event. The decision as
				to whether students will be able to attend is made by the Head of School and the Associate
		...
		<section class="parallax-object parallax-front">
			<div class="content-box">
				...
				this event. Any student who brings alcohol or who arrives under the influence of alcohol will not be
				allowed to attend and may face school disciplinary action.
			</div>
		</section>
	</article>
